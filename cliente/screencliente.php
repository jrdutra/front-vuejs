...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-buscar" role="tabpanel" aria-labelledby="nav-home-tab"><?php require_once('cliente/buscar.php'); ?></div>
  <div class="tab-pane fade" id="nav-novo" role="tabpanel" aria-labelledby="nav-profile-tab"><?php require_once('cliente/novo.php'); ?></div>
</div>