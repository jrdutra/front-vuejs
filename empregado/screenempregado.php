...
<div class="tab-content" id="nav-tabContent">
  <div class="tab-pane fade show active" id="nav-buscar" role="tabpanel" aria-labelledby="nav-home-tab"><?php require_once('empregado/buscar.php'); ?></div>
  <div class="tab-pane fade" id="nav-novo" role="tabpanel" aria-labelledby="nav-profile-tab"><?php require_once('empregado/novo.php'); ?></div>
</div>